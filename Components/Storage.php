<?php
    ...
    $sql = "SELECT * FROM storge LIMIT {$startpage},{$pagelimit}";
    $sql1 = "SELECT id FROM storge";
...
<?php 
    ...
    <div class="table-responsive mt-3">
                    <table class="table table-hover ">
                        <thead>
                            <tr>
                            <th scope="col">Storage Picture.</th>
                                <th scope="col">Id</th>
                                ...
                                <?php foreach ($query as $Data) { ?>
                                    ...
                                    <td><img src="<?php echo $url. "/" .$Data['picture']; ?>" alt="img" srcset="" style="width: 100px;"></td>
                                        ...
                                        <td>
                                            ...
                                            <form method="post" action="<?php echo $url ?>proceed/deletestorage.php" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete <?php echo $Data['id']; ?>?');">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item">
                                <a href="<?php echo $url?>Components/Storage.php?page=1" aria-label="Previous" class="page-link text-black">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            <?php for ($i = 1; $i <= $totalPage; $i++) { ?>
                                <li class="page-item"><a href="<?php echo $url?>Components/Storage.php?page=<?php echo $i; ?>" class="page-link text-black"><?php echo $i; ?></a></li>
                            <?php } ?>
                            <li class="page-item">
                                <a href="<?php echo $url?>Components/Storage.php?page=<?php echo $totalPage; ?>" aria-label="Next" class="page-link text-black">
