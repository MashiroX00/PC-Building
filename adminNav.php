                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Manage Action</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <div class="d-grid gap-2">
                                    <a href="#" role="button" class="btn btn-outline-primary popover-test" title="Go to Manage Account Page" data-bs-content="">Accout info</a>
                                    ...
                                    <a href="<?php echo $url;?>Admin_action.php" role="button" class="btn btn-outline-primary popover-test" title="Go to Manage Account Page" data-bs-content="">Admin Management</a>
                                </div>
                        </div>
