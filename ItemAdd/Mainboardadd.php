...
$alert = new alert();
$path = "proceed/mainboarddb.php";
isset($_POST['id']) ? $id = $_POST['id'] : $id = false;

if (!empty($id)) {
    $sql = "SELECT * FROM mainboard WHERE id = ?";
    ...
    $path = "proceed/mainboardedit.php";
}else {
    $name = "";
    $picture = "";
    $detail = "";
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 col-lg-6">
               ...
               $alert->unsetalert();
               ?>
                <form action="<?php echo $url.$path?>" method="POST" enctype="multipart/form-data">
                    <?php if (!empty($id)) : ?>
                        ...
                        <input type="text" class="form-control" placeholder="Name" aria-label="storage" aria-describedby="basic-addon1" name="id" value="<?php echo $id?>">
                    </div>
                        <?php endif ?>
                    <div class="input-group input-group-lg mb-3">
                    ...
                    <div class="input-group input-group-lg mb-3">
                        <label class="input-group-text" for="inputGroupSelect02"><i class="fa-solid fa-list fa-xl"></i></label>
                    ...
                    <div class="input-group input-group-lg mb-3">
                        ...
                        <select class="form-select" id="inputGroupSelect01" name="socket">
                            <option value="0">Choose CPU Socket</option>
                    ...
                    <?php if (!empty($id)):?>
                        <div>
                        <img src="<?php echo $url.$picture?>" alt="" class="img-thumbnail mb-3" width="200px">
                    </div>
                    <?php endif;?>
                    <div class="input-group input-group-lg mb-3">
